                ...
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        <span class="app-brand-logo demo"><img
                                src="https://alan.co.id/wp-content/uploads/2022/09/Logo-Alan-Creative-1536x360-1-768x180.png"
                                width="170" alt="image company"></span>
                    </a>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="https://source.unsplash.com/random/900x700/?user" alt width="35"
                                            height="35" style="object-fit: cover;" class="rounded-circle" />
                                    </div>
                                </a>
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online">
                                                        <img src="https://source.unsplash.com/random/900x700/?user"
